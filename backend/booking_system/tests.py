...
class NotificationServiceTests(TestCase):
    ...
    def test_send_notification_handles_client_error(self, mock_client_class):
        ...
        mock_client = MagicMock()
        mock_client_class.return_value = mock_client
        from backend.whatsapp.client import WhatsAppClientError
...
class CeleryTaskTests(TestCase):
    ...
    def test_send_reminder_24h_success(self, mock_send):
        ...
        from backend.booking_system.tasks import send_reminder_24h
    ...
    def test_send_reminder_1h_success(self, mock_send):
        ...
        from backend.booking_system.tasks import send_reminder_1h
